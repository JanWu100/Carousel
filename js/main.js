let startInput = [
  {
    ...
    title: "the man",
    bodyText: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum recusandae veniam nobis et commodi placeat, dignissimos molestias. Perspiciatis, magni! Libero, quasi dolore blanditiis magni nobis modi sit mollitia repellendus rem!",
  },
  {
    image: `https://source.unsplash.com/random?sig=${Math.floor(
      Math.random() * 500
...
addSlide.addEventListener("click", () => {
  ...
  if (startInput.length > 20) {
    ...
    startInput.push({
      ...
      title: document.querySelector(".title-input").value === "" ? "Generic Title" : document.querySelector(".title-input").value,
